...
begin
    ...
    execute format('
        ...
        for each row
        execute function %I();
    ', 'enroll_credit_func_'||NEW.entry_number, NEW.entry_number, 'enroll_credit_'||NEW.entry_number, 'credit_'||NEW.entry_number, 'enroll_credit_func_'||NEW.entry_number);
    ...
    execute format('
        ...
        for each row
        execute function %I();
    ', 'enroll_audit_func_'||NEW.entry_number, NEW.entry_number, 'enroll_audit_'||NEW.entry_number, 'audit_'||NEW.entry_number, 'enroll_audit_func_'||NEW.entry_number);
    ...
    execute format('
        ...
        for each row
        execute function %I();
    ', 'enroll_drop_func_'||NEW.entry_number, NEW.entry_number, 'enroll_drop_'||NEW.entry_number, 'drop_'||NEW.entry_number, 'enroll_drop_func_'||NEW.entry_number);
